...
<script>
	...
	<body data-spy="scroll" data-target=".header" data-offset="50">
		...
		<div class="container container-for-com">
			<h2>Village Data Comparision :</h2>
			<hr>
				<form action="demo_comp.php" method="post">
					<div class="form-row">
							<div class="form-group col-md-12 l1">
									<label for="inputState">Select Villages to Compare</label>
									</div>
									<div class="form-group col-md-4 l2">
										<label class="containerc">Bhaskar Nagar
										  <input type="checkbox" name="bn" value="1">
										  <span class="checkmark"></span></label>
									</div>
									<div class="form-group col-md-4 l2">
										<label class="containerc">Jankhona Gaon
										  <input type="checkbox" name="jk" value="2">
										  <span class="checkmark"></span></label>
									</div>
									<div class="form-group col-md-4 l2">
										<label class="containerc">Kurukani Basti
										  <input type="checkbox" name="kk" value="3">
										  <span class="checkmark"></span></label>
									</div>
									<div class="form-group col-md-4 l2">
										<label class="containerc">Kokilamukh Missing Gaon
										  <input type="checkbox" name="km" value="4">
										  <span class="checkmark"></span></label>
									</div>
									<div class="form-group col-md-4 l2">
										<label class="containerc">Pahukotia Shyam Gaon
						...
						<label for="inputState">Select Head-Section</label>
						...
						<div class="form-group col-md-4 l1">
						<label for="inputState">Select Sub-Section</label>
					...
					<hr>
			<div class="form-row">	
				<button type="submit" name="submit" class="btn btn-primary custom-button btn-lg col-md-12"><b>COMPARE</b></button>
			</div>
			</form>
