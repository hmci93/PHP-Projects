...
<input type="text" name="crsCode" id="crsCode" value="<?php echo $subopt_obj->crsCode?>" class="form-control"></div>
<div class='form-group'><label>pMcode</label>
<input type="text" name="pMcode" id="pMcode" value="<?php echo $subopt_obj->pMcode?>" class="form-control"></div>
<div class='form-group'><label>subType</label>
<input type="text" name="subType" id="subType" value="<?php echo $subopt_obj->subType?>" class="form-control"></div>
<div class='form-group'><label>n2</label>
<input type="text" name="n2" id="n2" value="<?php echo $subopt_obj->n2?>" class="form-control"></div>
<div class='form-group'><label>n3</label>
<input type="text" name="n3" id="n3" value="<?php echo $subopt_obj->n3?>" class="form-control"></div>
<div class='form-group'><label>so_id</label>
<input type="text" name="so_id" id="so_id" value="<?php echo $subopt_obj->so_id?>" class="form-control"></div>
