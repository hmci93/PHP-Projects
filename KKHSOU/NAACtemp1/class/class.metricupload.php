<?php
 ...
 class metricupload{
  ...
  {$sql="SELECT * from metricupload";
  $result =$this->database->query($sql);
  $result =$this->database->result;
  while($row=mysqli_fetch_array($result)) {

    echo '<tr>
    <th scope="row">'. $row["up_metric_slno"].'</th>
    <td>'.$row["up_metric_metric_slno"].'</td>
    <td>'.$row["up_metric_title"].'</td>
    <td>'.$row["up_metric_url"].'</td>
    <td>'.$row["up_metric_block"].'</td>
    <td>'.$row["up_metric_reserved1"].'</td>
    <td>'.$row["up_metric_reserved2"].'</td>
    <td>'.$row["up_metric_reserved3"].'</td>
    <td>'.$row["up_metric_reserved4"].'</td>
    <td>'.$row["up_metric_reserved5"].'</td>
    <td>'.$row["up_metric_reserved6"].'</td>
    <td>'.$row["up_metric_reserved7"].'</td>
    <td>'.$row["up_metric_reserved8"].'</td>
    <td>'.$row["up_metric_reserved9"].'</td>
    <td>'.$row["up_metric_reserved10"].'</td>
    <td>'.$row["up_metric_reserved11"].'</td>
    <td>'.$row["up_metric_reserved12"].'</td>
    <td>'.$row["up_metric_reserved13"].'</td>
    <td>'.$row["up_metric_reserved14"].'</td>
    <td>'.$row["up_metric_reserved15"].'</td>
    <td>'.$row["up_metric_reserved16"].'</td>
    <td>'.$row["up_metric_reserved17"].'</td>
    <td>'.$row["up_metric_reserved18"].'</td>
    <td>'.$row["up_metric_reserved19"].'</td>
    <td>'.$row["up_metric_reserved20"].'</td>
    <td><a class="btn btn-primary" href="../ui/metricuploadEditForm.php?up_metric_slno='.$row["up_metric_slno"].'">Edit</a></td>
    </tr>';
    }}
	  $result=$this->database->query($sql);}
