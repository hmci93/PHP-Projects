<?php
 ...
 class criterion{
  ...
  function selectDisplay()
    ...
    echo '<tr>
    <th scope="row">'. $row["crite_slno"].'</th>
    <td>'.$row["crite_title"].'</td>
    <td>'.$row["crite_block"].'</td>
    <td>'.$row["crite_descrip"].'</td>
    <td>'.$row["crite_reserved1"].'</td>
    <td>'.$row["crite_reserved2"].'</td>
    <td>'.$row["crite_reserved3"].'</td>
    <td>'.$row["crite_reserved4"].'</td>
    <td>'.$row["crite_reserved5"].'</td>
    <td>'.$row["crite_reserved6"].'</td>
    <td>'.$row["crite_reserved7"].'</td>
    <td>'.$row["crite_reserved8"].'</td>
    <td>'.$row["crite_reserved9"].'</td>
    <td>'.$row["crite_reserved10"].'</td>
    <td>'.$row["crite_reserved11"].'</td>
    <td>'.$row["crite_reserved12"].'</td>
    <td>'.$row["crite_reserved13"].'</td>
    <td>'.$row["crite_reserved14"].'</td>
    <td>'.$row["crite_reserved15"].'</td>
    <td>'.$row["crite_reserved16"].'</td>
    <td>'.$row["crite_reserved17"].'</td>
    <td>'.$row["crite_reserved18"].'</td>
    <td>'.$row["crite_reserved19"].'</td>
    <td>'.$row["crite_reserved20"].'</td>
    <td><a class="btn btn-primary" href="../ui/criterionEditForm.php?crite_slno='.$row["crite_slno"].'">Edit</a></td>
    </tr>';
    }}
	// $this->crite_slno=$row->crite_slno;
	// $this->crite_title=$row->crite_title;
