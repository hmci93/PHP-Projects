  ...
  <head>
    ...
    <script>
        grecaptcha.ready(function() {
          grecaptcha.execute('6Ld3yq4UAAAAAGR0LlUJDvPjuQ6HktwHXMoRN7Uj', { action: 'contact' }).then(function (token) {
      ...
      <div id="form_input" class="col-lg-12" >
        <form action="content.php" method="post">
          <div class="input-group input-group-lg">
            <input type="text" class="form-control" name="app_id" onkeypress="return isNumber(event)" placeholder="Enter Your Application Number" aria-label="Application Id" aria-describedby="basic-addon2" required>
            ...
            if ($recaptcha->score >= 0.5) {
              ...
              if (isset($_POST['submit'])) {
                ...
                if (is_numeric($app_id)) {
                  ...
                  ?>
                  <div class="alert alert-danger text-center" role="alert">
                      <h5>OOPS!! <strong>Invalid</strong> Number...</h5><br><h5>Should Contain Only Numbers..</h5>
                  </div>
                  <?php
                }
              }
