...
<html lang="en">
    ...
    <br>
        ...
        <!-- Modal -->
        <div class="modal fade videoCarousel" style="background: none;" id="videoCarousel" data-backdrop="static" data-keyboard="false" tabindex="-1">
            <link href="https://vjs.zencdn.net/7.8.4/video-js.css" rel="stylesheet" />
            <script src="https://vjs.zencdn.net/ie8/1.1.2/videojs-ie8.min.js"></script>
            <script>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                            <div class="container-fluid">
                                <div class="row">
                                    <h5 class="v_title" id="v_title"></h5>
                                </div>
                                <div class="row">
                                    <h5 class="col-6 v_cat" id="v_cat"></h5>
                                    <h5 class="col-6 v_likes" id="v_likes"></h5>
                                </div>
                            </div>
                        ...
                        <div class="container-fluid">
                            <div class="row align-items-center">
                                <div class="col-1 col-md-1">
                                    <button class="previous round prevVideo" id="prevVideo" role="button">
                                        <span class="fa fa-angle-double-left" aria-hidden="true"></span>
                                    </button>
                                </div>
                                <div class="col-10 col-md-10">
                                    <!-- <div id="playerCarousel" class="carousel slide"> -->
                                ...
                                <div class="col-1 col-md-1">
                                    <button class="next round nextVideo" id="nextVideo" role="button">
