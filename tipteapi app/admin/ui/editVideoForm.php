...
<html lang="en">
    <head>
        ...
        <title>Edit Video Asset - TipTeapai</title>
        ...
        <script>
            $(document).ready(function(){
                ...
                $.post('http://api.tipteapi.com/api_getVideo2.php', {
                    ...
                    $("#v_id").val($.trim(res_obj[0]['v_id']));
                    $("#assetVideoOld").val($.trim(res_obj[0]['assetVideo']).substring(14, $.trim(res_obj[0]['assetVideo']).lastIndexOf('_')));
                });
             });
        </script>
        <script>
            function uploadData() {
                ...
                $.post("http://api.tipteapi.com/api_updateVideo.php", {
                    category: cat,
                    userId: user_id,
                    place: place,
                    v_id: v_id,
        ...
        <script>
            function renameVideoFile() {
                var assetVideoOld = $("#assetVideoOld").val();
                var assetVideoNew = $("#assetVideoNew").val();
                var v_id = '<?php echo $v_id; ?>';
                var api_key = '<?php echo $api_key; ?>';

                $.post("http://api.tipteapi.com/api_updateVideo.php", {
                    assetVideoOld: assetVideoOld,
                    assetVideoNew: assetVideoNew,
                    v_id: v_id,
                    api_key: api_key
                }, function(res2) {
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Edit Video Asset</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item"><a href="../process/videoListProcess.php">Video Assets</a></li>
                            <li class="breadcrumb-item active">Edit Video Assets</li>
                        </ol>
                        <div class="card mb-4">
                            <div class="card-header">
                                <i class="fas fa-chart-area mr-1"></i>
                                Video Asset Edit Form
                            </div>
                            <div class="card-body">
                                <form id="form1">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form id="form2">
                                    ...
                                    <div class="form-group row">
                                        <label for="assetVideoOld" class="col-md-3 col-form-label"><h5>Video Filename (OLD): </h5></label>
                                        <input type="text" name="assetVideoOld" id="assetVideoOld" value="" class="col-md-9 form-control" readonly required>
                                    </div>
                                    <div class="form-group row">
                                        <label for="assetVideoNew" class="col-md-3 col-form-label"><h5>Video Filename (New): <font color="red">*</font></h5></label>
                                        <input type="text" name="assetVideoNew" id="assetVideoNew" value="" class="col-md-9 form-control" required>
                                    </div>
                                    <div class="form-group row">
                                        <input type="button" value="Update" class="col-md-9 offset-md-3 btn btn-primary btn-block" onclick="renameVideoFile();">
                                    </div>
                                </form>
                            </div>
                        </div>
