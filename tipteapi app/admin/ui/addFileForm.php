...
<html lang="en">
    <head>
        ...
        <title>Add File Asset - TipTeapai</title>
        ...
        <script>
            function addFile() {
                ...
                $.ajax({
                    url: 'http://api.tipteapi.com/api_putFile.php',
                    type: 'POST',
                    data: formData,
                    contentType: false,
                    cache: false,
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Add File Asset</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                            <li class="breadcrumb-item active">Add File Assets</li>
                        </ol>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <form id="form4" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row">
                                        <label for="assetFile" class="col-md-3 col-form-label"><h4>Choose File: <font color="red">*</font></h4></label>
                                        <input type="file" name="assetFile" id="assetFile" class="col-md-9 form-control-file" required>
                                    </div>
                                    <div class="form-group row">
                                        <input type="hidden" name="api_key" id="api_key" class="col-md-9 form-control" value="<?php echo $api_key; ?>" required>
                                    </div>
                                    <div class="form-group row">
                                        <input type="button" value="Add File" class="col-md-9 offset-md-3 btn btn-primary btn-block" onclick="addFile();">
                                    </div>
                                </form>
                            </div>
                        </div>
