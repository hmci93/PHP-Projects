...
<div>
<center>
<form name="keyboard" method="post" action="synonym.php" enctype="multipart/form-data" >
<center>
<table style="position:relative; border-spacing:10px; border-collapse:separate;">
<tr>
...
{
?>
<input type="text" class="form-control" name="word" value="<?php echo $row['word']; ?>" style="width:200px;height:40px;" readonly="readonly" required>
<?php
}
?>
</td>
...
<table style="position:relative; border-spacing:10px; border-collapse:separate; width:950px;">
<tr>
<td align="right">১</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" onclick="elementid(this)" id="1" name="1" autocomplete="off" required="required"></td>
<td align="right">২</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" id="2" name="2" onclick="elementid(this)" autocomplete="off" ></td>
<td align="right">৩</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" id="3" name="3" onclick="elementid(this)" autocomplete="off" ></td>
<td align="right">৪</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" onclick="elementid(this)" name="4" id="4" autocomplete="off"></td>
</tr>
<tr>
<td align="right">৫</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" id="5" name="5" onclick="elementid(this)" autocomplete="off"></td>
<td align="right">৬</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" id="6" name="6" onclick="elementid(this)" autocomplete="off"></td>
<td align="right">৭</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" id="7" name="7" onclick="elementid(this)" autocomplete="off"></td>
<td align="right">৮</td>
<td><input type="text" class="form-control" style="width:200px;height:40px;" maxlength="50" onKeyup="writeassamese(this)" id="8" name="8" onclick="elementid(this)" autocomplete="off"></td>
<tr>
<td></td>
<td></td>
<td></td>
<td align="right"><button type="submit" name="insert" id="upload" class="btn btn-info" style="width:100px;">জমা কৰক</button></td>
<td></td>
<td align="left"><input type="button" class="btn btn-info" id="virtualkeyboard"  style="width:100px;" value="কিবর্ড" /></td>
<td></td>
<td></td>
</tr>
</table>
...
<?php
if(isset($_POST["insert"]) && ($_POST["word"]))
{
$word=trim($_POST["word"]);
$word=mysqli_real_escape_string($con,$word);
mysqli_set_charset($con,"utf8");
...
while($count<9)
{
$meaning=trim($_POST[$count]);
$meaning=mysqli_real_escape_string($con,$meaning);
mysqli_set_charset($con,"utf8");
if(!empty($meaning))
mysqli_query($con,"Insert into synonym values('','$wid','$meaning')");
$count++;
}
...
<div class="container"  style="width:800px;">
  <div class="panel panel-default">
    <div class="panel-body">
    <p style="text-align:justify;"><font style="color: #333; font-style:italic;">
