...
define("EW_PROJECT_NAME", "FinalAdminPanel4OAD_21JUNE2018", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME, TRUE); // Config file name
define("EW_PROJECT_ID", "{D0DA1526-8691-4077-AB0F-4906FF8D16B3}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", '7plmJ7ZELSG1wmjA', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/FinalAdminPanel4OAD_21JUNE2018.css", TRUE); // Project stylesheet file name
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "assam1pw_astec", "pass" => "jecmca", "db" => "assam1pw_dictionary", "qs" => "`", "qe" => "`");
...
define("EW_USER_TABLE", "`role`", TRUE);
