...
<center>
<form name="keyboard" method="post" action="display.php" enctype="multipart/form-data">
<select name="lang" id="lang" onchange="writeword()" style="height:40px; width:75px; border:thin; border-style:solid; border-color: #69C;border-top-left-radius: 4px; border-bottom-left-radius:4px; border-right:none;">
...
{
		echo '<center><div class="alert alert-warning" style="position:relative; top:5px; width:600px;">
...
if(isset($word))
{
	...
	<table style="position:relative; border:thin; border-style:solid; border-spacing:5px; border-collapse:separate; width:600px; border-radius:4px; border-color: #999; box-shadow:3px 3px 8px grey;">
		...
		if(mysqli_num_rows($extract)>0)
		{
			...
			{	
		?>
 				<a href="display.php?str=<?php echo $row["synonym"];?>"><?php echo $row["synonym"].",";?></a>
		<?php
			}
			?>
            </td><td></td></tr>
